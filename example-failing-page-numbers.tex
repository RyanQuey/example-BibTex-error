...
% BibLaTex options
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% is this redundant with the usepackage below? 
...
% Not sure if I want to use this instead...it's what is used in the file to generate the docs AND in biblatex-sbl-examples.tex, but NOT used in the example file sbl-paper.tex. So I'm following sbl-paper.tex for now...
